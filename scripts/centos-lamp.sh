...
cd /vagrant
sudo -u vagrant wget -q https://raw.githubusercontent.com/lfallo1/vagrant-lamp/master/files/info.php
sudo -u vagrant wget -q https://raw.githubusercontent.com/lfallo1/vagrant-lamp/master/files/index.html
